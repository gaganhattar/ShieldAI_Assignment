...
class TestFileOperationsDebPackageFunction(unittest.TestCase):
    ...
    def test_package_generation(self):
        ...
        try:
            ...
            subprocess.run(["python", "create_package.py"])
    ...
    def test_package_installation(self):
        ...
        try:
            ...
            expected_files = ["main.py", "create_package.py", "copy_file.py", "combine_files.py", "delete_file.py", "test_create_file.py", 
                              "test_copy_file.py", "test_combine_files.py", "test_delete_file.py", "test_main.py"]
            
            for file in expected_files:
                self.assertTrue(os.path.exists(f"/usr/bin/{file}"))
        except Exception as e:
    ...
    def test_package_uninstallation(self):
        ...
        try:
            ...
            expected_files = ["main.py", "create_package.py", "copy_file.py", "combine_files.py", "delete_file.py", "test_create_file.py", "test_copy_file.py", 
                              "test_combine_files.py", "test_delete_file.py", "test_main.py"]
            
            for file in expected_files:
                self.assertFalse(os.path.exists(f"/usr/bin/{file}"))
        except Exception as e:
